...
class environment(object):
    ...
    def relax(self, accuracy=0.05):
        self.config.atoms.set_constraint(
    ...
    def saddle(
        self, moved_atom=-1, accuracy=0.1, n_points=10, r_cut=4, platform="matlantis"
    ):
